...
class BudgetSpec extends FlatSpec with Matchers {
 ...
 "it" should "return one new copy of Budget when add new Revenue" in {
  ...
  "it" should "return one new copy of Budget with Expenditure updated" in {
   ...
   "it" should "update the balance of the Budget when update the Expenditure" in {
	     val copy = budget addExp Expenditure("Hotel", 100.0, "Travel") updateExp Expenditure("Hotel", 50.0, "Travel", false, 0)  // full object 
   ...
   "it" should "ignore the update the balance Budget whe it  don't have the Expenditure" in {
	   val copy = budget addExp Expenditure("Hotel", 100.0, "Travel") addExp Expenditure("Hotel", 100.0, "Travel") updateExp Expenditure("Hotel", 50.0, "Travel", false, 2)  // full object 
	   copy.balance should be(-200.0)
   }   
